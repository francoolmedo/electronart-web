...
(function () {
  ...
  var T = {
    en: {
      ...
      "sobre tu diseño": "on your design",
      "—en oro lo que agrega, tachado lo que saca, con su recorrido lo que mueve— y no toca nada hasta que aceptás. Se abre con Ctrl+I.": "— gold for what it adds, crossed out for what it removes, a path for what it moves — and it touches nothing until you accept. Opens with Ctrl+I.",
      "Aceptás sólo lo que querés.": "You accept only what you want.",
      "Cada cambio va en una lista con su tilde; destildás uno y desaparece del dibujo al instante. Lo que apliques entra como": "Every change is a ticked line; untick one and it disappears from the drawing straight away. What you apply lands as",
      "un solo Ctrl+Z": "a single Ctrl+Z",
      ", y si algo falla el diseño queda exactamente como estaba.": ", and if anything fails your design is left exactly as it was.",
      "Sabe trabajar en los cuatro editores": "It works in all four editors",
      ": en la placa (planos de cobre, ruteo, mover componentes, agujeros de montaje, verificación de reglas), en el esquemático (buscar en la biblioteca, colocar, conectar), en simulación (punto de operación, chequeo eléctrico, cálculo de divisores con valores que se consiguen) y en ladder (escalones y el arranque-paro con enclavamiento).": ": on the board (copper pours, routing, moving parts, mounting holes, rule checking), on the schematic (searching the library, placing, wiring), in simulation (operating point, electrical check, divider maths with values you can actually buy) and in ladder (rungs and the sealed-in start/stop).",
      "Puede correr en tu máquina.": "It can run on your machine.",
      "Con tu propia clave, o contra un modelo local: ahí el diseño no sale de tu computadora. Para trabajo bajo acuerdo de confidencialidad, esa diferencia lo es todo.": "With your own API key, or against a local model — then your design never leaves your computer. For work under an NDA, that difference is everything.",
      "El visor 3D abre casi al instante": "The 3D viewer opens almost instantly",
      ": la misma placa que tardaba cinco segundos y medio ahora aparece en menos de dos décimas, y con": ": the same board that took five and a half seconds now appears in under two tenths, and with",
      "más": "more",
      "detalle que antes, no menos.": "detail than before, not less.",
      "Los componentes se ven como son": "Components look like themselves",
      ": modelos reales con el color de cada pieza —el epoxi negro, las patas plateadas, la lata del módulo—, y cada encapsulado del tamaño que le corresponde según sus pines.": ": real models with each part in its own colour — black epoxy, silver leads, the module's metal can — and every package the size its pin count calls for.",
      "El canto de la placa es FR-4": "The board edge is bare FR-4",
      ", como sale de la fresadora, y las pistas se ven bajo la máscara en vez de como cobre desnudo.": ", as it comes off the router, and the tracks show under the mask instead of as bare copper.",
      "Planos de cobre con la forma que quieras": "Copper pours in any shape",
      ": un clic por vértice, se cierra con Enter y se vierte solo.": ": one click per vertex, close with Enter and it pours itself.",
      "Política de privacidad publicada, y el sitio ahora cuenta visitas sin cookies ni servicios de terceros.": "Privacy policy published, and the site now counts visits with no cookies and no third-party services.",
      "en camino": "coming soon",
      "ElectronArt frente a KiCad, Altium, EasyEDA y Flux — comparación": "ElectronArt vs KiCad, Altium, EasyEDA and Flux — a comparison",
      "Cómo se compara ElectronArt": "How ElectronArt compares",
      "Comparación honesta con los programas que probablemente ya esté evaluando. Incluye los casos en los que le conviene otro y no éste: perder media hora leyendo esto es más barato que elegir mal.": "An honest comparison with the tools you are probably already weighing up. It includes the cases where another one suits you better than this one: half an hour reading this is cheaper than choosing wrong.",
      "La versión corta": "The short version",
      "ElectronArt es una suite de escritorio que hace el esquemático, el ruteo de la placa, la simulación SPICE, el diagrama Ladder y el esquema eléctrico IEC": "ElectronArt is a desktop suite that does schematic capture, board routing, SPICE simulation, Ladder diagrams and IEC electrical drawings",
      "en el mismo programa": "in the same program",
      ", funciona sin conexión y está en castellano de origen. Es el único que junta la parte electrónica con la parte de mando industrial.": ", works offline, and is written in Spanish from the ground up. It is the only one that puts the electronics and the industrial control side together.",
      "No es el más maduro ni el que tiene la biblioteca más grande. Si necesita ocho capas, un equipo trabajando sobre la misma placa o el respaldo de una empresa grande, hay opciones mejores y están nombradas acá abajo.": "It is not the most mature one, nor the one with the biggest library. If you need eight layers, a team working on the same board, or the backing of a large company, there are better options and they are named below.",
      "Contra KiCad": "Against KiCad",
      "KiCad es gratis, es libre y es muy bueno. Es la comparación más difícil y la más honesta de hacer.": "KiCad is free, it is open source, and it is very good. This is the hardest comparison to make, and the most honest one.",
      "Elija KiCad si:": "Choose KiCad if:",
      "quiere costo cero, la biblioteca de componentes más grande que existe, o una comunidad enorme donde cualquier duda ya está contestada.": "you want zero cost, the largest component library there is, or a huge community where any question has already been answered.",
      "Elija ElectronArt si:": "Choose ElectronArt if:",
      "trabaja también con lógica de mando —Ladder, contactores, esquemas IEC— y no quiere saltar entre dos programas; si prefiere una interfaz en castellano en vez de una traducción parcial; o si quiere un asistente que le proponga los cambios y se los dibuje encima antes de aplicarlos.": "you also work with control logic — Ladder, contactors, IEC drawings — and would rather not jump between two programs; if you prefer a native Spanish interface over a partial translation; or if you want an assistant that proposes changes and draws them over your design before applying them.",
      "Contra Altium Designer": "Against Altium Designer",
      "Altium es el estándar de la industria y se nota. También cuesta lo que cuesta un auto usado por año.": "Altium is the industry standard and it shows. It also costs as much as a used car every year.",
      "Elija Altium si:": "Choose Altium if:",
      "hace placas de alta velocidad con muchas capas, trabaja en equipo sobre el mismo diseño, o su cliente le exige entregar el proyecto en ese formato.": "you build high-speed boards with many layers, work as a team on the same design, or your client requires the project delivered in that format.",
      "es una persona o un taller chico, y ese precio no cierra por más que la herramienta sea buena. Las funciones que usa todos los días —esquemático, ruteo con reglas, planos de cobre, Gerber, BOM— están, y la licencia sale una fracción.": "you are one person or a small shop, and that price does not add up no matter how good the tool is. The features you use every day — schematic, rule-driven routing, copper pours, Gerber, BOM — are all here, and the licence costs a fraction.",
      "Contra Eagle": "Against Eagle",
      "Eagle dejó de venderse por separado y su camino de actualización es Fusion, que es una suite de mecánica con electrónica adentro.": "Eagle is no longer sold on its own, and its upgrade path is Fusion — a mechanical CAD suite with electronics inside it.",
      "Elija Fusion si:": "Choose Fusion if:",
      "el diseño mecánico manda y la placa es una parte de un conjunto que ya modela ahí.": "mechanical design is what drives the project and the board is one part of an assembly you already model there.",
      "venía usando Eagle por lo que era —un programa de placas, liviano, de escritorio— y no quiere mudarse a una suite de CAD entera para seguir haciendo lo mismo.": "you were using Eagle for what it was — a light desktop board program — and you would rather not move to a whole CAD suite just to keep doing the same thing.",
      "Contra EasyEDA": "Against EasyEDA",
      "EasyEDA es gratis y está pegado a un fabricante: se diseña y se manda a hacer sin salir de la página.": "EasyEDA is free and tied to a manufacturer: you design and order the board without leaving the page.",
      "Elija EasyEDA si:": "Choose EasyEDA if:",
      "va a fabricar con ese proveedor y quiere el camino más corto entre el diseño y la placa en la mano.": "you are going to manufacture with that supplier and want the shortest path between the design and the board in your hand.",
      "no quiere que su diseño viva en el servidor de otro, necesita trabajar sin internet, o no quiere quedar atado a una única fábrica.": "you do not want your design living on someone else's server, you need to work without internet, or you do not want to be tied to a single factory.",
      "Contra Flux": "Against Flux",
      "Flux es el que más se le parece en la idea: un asistente que ayuda a diseñar. La diferencia es dónde corre y cómo se paga.": "Flux is the closest one in spirit: an assistant that helps you design. The difference is where it runs and how you pay for it.",
      "Elija Flux si:": "Choose Flux if:",
      "quiere trabajar en el navegador, en equipo y en tiempo real, y la suscripción mensual no le molesta.": "you want to work in the browser, as a team and in real time, and a monthly subscription does not bother you.",
      "necesita que el asistente corra": "you need the assistant to run",
      "en su máquina": "on your own machine",
      ". Para trabajo bajo acuerdo de confidencialidad esa diferencia lo es todo: el diseño no sale de la computadora. Y porque acá el programa sigue funcionando cuando se cae internet.": ". For work under an NDA that difference is everything: the design never leaves the computer. And because here the program keeps working when the internet goes down.",
      "Contra Proteus": "Against Proteus",
      "Proteus es fuerte en simulación con microcontrolador: se le carga el firmware y se lo ve correr contra el circuito.": "Proteus is strong at microcontroller simulation: you load the firmware and watch it run against the circuit.",
      "Elija Proteus si:": "Choose Proteus if:",
      "su trabajo es sobre todo simular firmware antes de tener la placa.": "your work is mostly simulating firmware before the board exists.",
      "necesita el flujo completo hasta la fabricación, y además la parte de mando industrial en el mismo lugar.": "you need the whole flow through to manufacturing, plus the industrial control side in the same place.",
      "La tabla": "The table",
      "Asistente que dibuja el cambio antes de aplicarlo": "Assistant that draws the change before applying it",
      "El asistente puede correr en su máquina": "The assistant can run on your machine",
      "Esquemático y PCB": "Schematic and PCB",
      "Esquemas eléctricos IEC": "IEC electrical drawings",
      "Funciona sin conexión": "Works offline",
      "Interfaz en castellano de origen": "Native Spanish interface",
      "Exportación Gerber y BOM": "Gerber and BOM export",
      "Biblioteca de componentes muy grande": "Very large component library",
      "Trabajo en equipo sobre el mismo diseño": "Team work on the same design",
      "«~» significa parcial o con limitaciones. Las dos últimas filas son las que ElectronArt todavía no gana, y están puestas a propósito.": "\"~\" means partial or limited. The last two rows are the ones ElectronArt does not win yet, and they are there on purpose.",
      "Pruébelo sin pagar nada": "Try it without paying anything",
      "La edición gratuita no vence y no pide tarjeta. Bájela, haga una placa de verdad y recién ahí decida.": "The free edition does not expire and does not ask for a card. Download it, build a real board, and only then decide.",
      "Descargar ElectronArt": "Download ElectronArt",
      "Ver todas las funciones y los precios": "See all the features and prices",
      "Comparación orientativa, escrita en agosto de 2026. Las marcas de terceros pertenecen a sus dueños y no hay ninguna relación entre ellos y ElectronArt. Los programas cambian: si encuentra algo desactualizado o injusto, escríbanos y lo corregimos.": "Indicative comparison, written in August 2026. Third-party trademarks belong to their owners and there is no relationship between them and ElectronArt. Programs change: if you find anything out of date or unfair, write to us and we will correct it.",
      "Comparación en detalle, uno por uno →": "Detailed comparison, one by one →",
      "Tus proyectos de KiCad y EAGLE abren acá": "Your KiCad and EAGLE projects open here",
      "✓ Abre tus proyectos de KiCad y EAGLE": "✓ Opens your KiCad and EAGLE projects",
    ...
    pt: {
      ...
      "sobre tu diseño": "sobre o seu projeto",
      "—en oro lo que agrega, tachado lo que saca, con su recorrido lo que mueve— y no toca nada hasta que aceptás. Se abre con Ctrl+I.": "— em dourado o que adiciona, riscado o que remove, com o percurso o que move — e não toca em nada até você aceitar. Abre com Ctrl+I.",
      "Aceptás sólo lo que querés.": "Você aceita apenas o que quiser.",
      "Cada cambio va en una lista con su tilde; destildás uno y desaparece del dibujo al instante. Lo que apliques entra como": "Cada mudança é uma linha marcada; desmarque uma e ela some do desenho na hora. O que você aplicar entra como",
      "un solo Ctrl+Z": "um único Ctrl+Z",
      ", y si algo falla el diseño queda exactamente como estaba.": ", e se algo falhar o projeto fica exatamente como estava.",
      "Sabe trabajar en los cuatro editores": "Sabe trabalhar nos quatro editores",
      ": en la placa (planos de cobre, ruteo, mover componentes, agujeros de montaje, verificación de reglas), en el esquemático (buscar en la biblioteca, colocar, conectar), en simulación (punto de operación, chequeo eléctrico, cálculo de divisores con valores que se consiguen) y en ladder (escalones y el arranque-paro con enclavamiento).": ": na placa (planos de cobre, roteamento, mover componentes, furos de montagem, verificação de regras), no esquemático (buscar na biblioteca, colocar, ligar), em simulação (ponto de operação, verificação elétrica, cálculo de divisores com valores que se compram) e em ladder (degraus e o liga-desliga com selo).",
      "Puede correr en tu máquina.": "Pode rodar na sua máquina.",
      "Con tu propia clave, o contra un modelo local: ahí el diseño no sale de tu computadora. Para trabajo bajo acuerdo de confidencialidad, esa diferencia lo es todo.": "Com a sua própria chave, ou com um modelo local — aí o projeto nunca sai do seu computador. Para trabalho sob acordo de confidencialidade, essa diferença é tudo.",
      "El visor 3D abre casi al instante": "O visualizador 3D abre quase instantaneamente",
      ": la misma placa que tardaba cinco segundos y medio ahora aparece en menos de dos décimas, y con": ": a mesma placa que levava cinco segundos e meio agora aparece em menos de dois décimos, e com",
      "más": "mais",
      "detalle que antes, no menos.": "detalhe do que antes, não menos.",
      "Los componentes se ven como son": "Os componentes têm a sua cara",
      ": modelos reales con el color de cada pieza —el epoxi negro, las patas plateadas, la lata del módulo—, y cada encapsulado del tamaño que le corresponde según sus pines.": ": modelos reais com a cor de cada peça — o epóxi preto, os terminais prateados, a blindagem do módulo — e cada encapsulamento no tamanho que corresponde aos seus pinos.",
      "El canto de la placa es FR-4": "A borda da placa é FR-4 nu",
      ", como sale de la fresadora, y las pistas se ven bajo la máscara en vez de como cobre desnudo.": ", como sai da fresa, e as trilhas aparecem sob a máscara em vez de como cobre nu.",
      "Planos de cobre con la forma que quieras": "Planos de cobre com a forma que quiser",
      ": un clic por vértice, se cierra con Enter y se vierte solo.": ": um clique por vértice, feche com Enter e ele se preenche sozinho.",
      "Política de privacidad publicada, y el sitio ahora cuenta visitas sin cookies ni servicios de terceros.": "Política de privacidade publicada, e o site agora conta visitas sem cookies nem serviços de terceiros.",
      "en camino": "a caminho",
      "ElectronArt frente a KiCad, Altium, EasyEDA y Flux — comparación": "ElectronArt frente a KiCad, Altium, EasyEDA e Flux — comparação",
      "Cómo se compara ElectronArt": "Como o ElectronArt se compara",
      "Comparación honesta con los programas que probablemente ya esté evaluando. Incluye los casos en los que le conviene otro y no éste: perder media hora leyendo esto es más barato que elegir mal.": "Uma comparação honesta com os programas que você provavelmente já está avaliando. Inclui os casos em que outro serve melhor do que este: meia hora lendo isto sai mais barato do que escolher errado.",
      "La versión corta": "A versão curta",
      "ElectronArt es una suite de escritorio que hace el esquemático, el ruteo de la placa, la simulación SPICE, el diagrama Ladder y el esquema eléctrico IEC": "O ElectronArt é uma suíte de desktop que faz o esquemático, o roteamento da placa, a simulação SPICE, o diagrama Ladder e o esquema elétrico IEC",
      "en el mismo programa": "no mesmo programa",
      ", funciona sin conexión y está en castellano de origen. Es el único que junta la parte electrónica con la parte de mando industrial.": ", funciona sem conexão e é feito em espanhol desde a origem. É o único que junta a parte eletrônica com a parte de comando industrial.",
      "No es el más maduro ni el que tiene la biblioteca más grande. Si necesita ocho capas, un equipo trabajando sobre la misma placa o el respaldo de una empresa grande, hay opciones mejores y están nombradas acá abajo.": "Não é o mais maduro nem o que tem a maior biblioteca. Se você precisa de oito camadas, de uma equipe trabalhando na mesma placa ou do respaldo de uma empresa grande, há opções melhores e elas estão nomeadas abaixo.",
      "Contra KiCad": "Contra o KiCad",
      "KiCad es gratis, es libre y es muy bueno. Es la comparación más difícil y la más honesta de hacer.": "O KiCad é gratuito, é livre e é muito bom. É a comparação mais difícil de fazer, e a mais honesta.",
      "Elija KiCad si:": "Escolha o KiCad se:",
      "quiere costo cero, la biblioteca de componentes más grande que existe, o una comunidad enorme donde cualquier duda ya está contestada.": "você quer custo zero, a maior biblioteca de componentes que existe, ou uma comunidade enorme onde qualquer dúvida já foi respondida.",
      "Elija ElectronArt si:": "Escolha o ElectronArt se:",
      "trabaja también con lógica de mando —Ladder, contactores, esquemas IEC— y no quiere saltar entre dos programas; si prefiere una interfaz en castellano en vez de una traducción parcial; o si quiere un asistente que le proponga los cambios y se los dibuje encima antes de aplicarlos.": "você também trabalha com lógica de comando — Ladder, contatores, esquemas IEC — e não quer pular entre dois programas; se prefere uma interface em espanhol em vez de uma tradução parcial; ou se quer um assistente que proponha as mudanças e as desenhe por cima antes de aplicá-las.",
      "Contra Altium Designer": "Contra o Altium Designer",
      "Altium es el estándar de la industria y se nota. También cuesta lo que cuesta un auto usado por año.": "O Altium é o padrão da indústria e isso se nota. Também custa o que custa um carro usado por ano.",
      "Elija Altium si:": "Escolha o Altium se:",
      "hace placas de alta velocidad con muchas capas, trabaja en equipo sobre el mismo diseño, o su cliente le exige entregar el proyecto en ese formato.": "você faz placas de alta velocidade com muitas camadas, trabalha em equipe no mesmo projeto, ou seu cliente exige a entrega nesse formato.",
      "es una persona o un taller chico, y ese precio no cierra por más que la herramienta sea buena. Las funciones que usa todos los días —esquemático, ruteo con reglas, planos de cobre, Gerber, BOM— están, y la licencia sale una fracción.": "você é uma pessoa ou uma oficina pequena, e esse preço não fecha por melhor que a ferramenta seja. Os recursos que você usa todo dia — esquemático, roteamento com regras, planos de cobre, Gerber, BOM — estão aqui, e a licença sai por uma fração.",
      "Contra Eagle": "Contra o Eagle",
      "Eagle dejó de venderse por separado y su camino de actualización es Fusion, que es una suite de mecánica con electrónica adentro.": "O Eagle deixou de ser vendido separadamente e seu caminho de atualização é o Fusion, que é uma suíte de mecânica com eletrônica dentro.",
      "Elija Fusion si:": "Escolha o Fusion se:",
      "el diseño mecánico manda y la placa es una parte de un conjunto que ya modela ahí.": "o projeto mecânico é que manda e a placa é uma parte de um conjunto que você já modela ali.",
      "venía usando Eagle por lo que era —un programa de placas, liviano, de escritorio— y no quiere mudarse a una suite de CAD entera para seguir haciendo lo mismo.": "você usava o Eagle pelo que ele era — um programa de placas, leve, de desktop — e não quer se mudar para uma suíte de CAD inteira para continuar fazendo a mesma coisa.",
      "Contra EasyEDA": "Contra o EasyEDA",
      "EasyEDA es gratis y está pegado a un fabricante: se diseña y se manda a hacer sin salir de la página.": "O EasyEDA é gratuito e está colado a um fabricante: você projeta e manda fabricar sem sair da página.",
      "Elija EasyEDA si:": "Escolha o EasyEDA se:",
      "va a fabricar con ese proveedor y quiere el camino más corto entre el diseño y la placa en la mano.": "você vai fabricar com aquele fornecedor e quer o caminho mais curto entre o projeto e a placa na mão.",
      "no quiere que su diseño viva en el servidor de otro, necesita trabajar sin internet, o no quiere quedar atado a una única fábrica.": "você não quer que seu projeto viva no servidor de outro, precisa trabalhar sem internet, ou não quer ficar preso a uma única fábrica.",
      "Contra Flux": "Contra o Flux",
      "Flux es el que más se le parece en la idea: un asistente que ayuda a diseñar. La diferencia es dónde corre y cómo se paga.": "O Flux é o que mais se parece na ideia: um assistente que ajuda a projetar. A diferença é onde ele roda e como se paga.",
      "Elija Flux si:": "Escolha o Flux se:",
      "quiere trabajar en el navegador, en equipo y en tiempo real, y la suscripción mensual no le molesta.": "você quer trabalhar no navegador, em equipe e em tempo real, e a assinatura mensal não te incomoda.",
      "necesita que el asistente corra": "você precisa que o assistente rode",
      "en su máquina": "na sua própria máquina",
      ". Para trabajo bajo acuerdo de confidencialidad esa diferencia lo es todo: el diseño no sale de la computadora. Y porque acá el programa sigue funcionando cuando se cae internet.": ". Para trabalho sob acordo de confidencialidade essa diferença é tudo: o projeto não sai do computador. E porque aqui o programa continua funcionando quando a internet cai.",
      "Contra Proteus": "Contra o Proteus",
      "Proteus es fuerte en simulación con microcontrolador: se le carga el firmware y se lo ve correr contra el circuito.": "O Proteus é forte em simulação com microcontrolador: você carrega o firmware e o vê rodar contra o circuito.",
      "Elija Proteus si:": "Escolha o Proteus se:",
      "su trabajo es sobre todo simular firmware antes de tener la placa.": "seu trabalho é sobretudo simular firmware antes de ter a placa.",
      "necesita el flujo completo hasta la fabricación, y además la parte de mando industrial en el mismo lugar.": "você precisa do fluxo completo até a fabricação, e ainda a parte de comando industrial no mesmo lugar.",
      "La tabla": "A tabela",
      "Asistente que dibuja el cambio antes de aplicarlo": "Assistente que desenha a mudança antes de aplicá-la",
      "El asistente puede correr en su máquina": "O assistente pode rodar na sua máquina",
      "Esquemático y PCB": "Esquemático e PCB",
      "Esquemas eléctricos IEC": "Esquemas elétricos IEC",
      "Funciona sin conexión": "Funciona sem conexão",
      "Interfaz en castellano de origen": "Interface em espanhol de origem",
      "Exportación Gerber y BOM": "Exportação Gerber e BOM",
      "Biblioteca de componentes muy grande": "Biblioteca de componentes muito grande",
      "Trabajo en equipo sobre el mismo diseño": "Trabalho em equipe no mesmo projeto",
      "«~» significa parcial o con limitaciones. Las dos últimas filas son las que ElectronArt todavía no gana, y están puestas a propósito.": "«~» significa parcial ou com limitações. As duas últimas linhas são as que o ElectronArt ainda não ganha, e estão aí de propósito.",
      "Pruébelo sin pagar nada": "Experimente sem pagar nada",
      "La edición gratuita no vence y no pide tarjeta. Bájela, haga una placa de verdad y recién ahí decida.": "A edição gratuita não expira e não pede cartão. Baixe, faça uma placa de verdade e só então decida.",
      "Descargar ElectronArt": "Baixar o ElectronArt",
      "Ver todas las funciones y los precios": "Ver todos os recursos e os preços",
      "Comparación orientativa, escrita en agosto de 2026. Las marcas de terceros pertenecen a sus dueños y no hay ninguna relación entre ellos y ElectronArt. Los programas cambian: si encuentra algo desactualizado o injusto, escríbanos y lo corregimos.": "Comparação orientativa, escrita em agosto de 2026. As marcas de terceiros pertencem aos seus donos e não há nenhuma relação entre elas e o ElectronArt. Os programas mudam: se encontrar algo desatualizado ou injusto, escreva e corrigimos.",
      "Comparación en detalle, uno por uno →": "Comparação em detalhe, um por um →",
      "Tus proyectos de KiCad y EAGLE abren acá": "Seus projetos de KiCad e EAGLE abrem aqui",
      "✓ Abre tus proyectos de KiCad y EAGLE": "✓ Abre os seus projetos de KiCad e EAGLE",
